...
def main():
    ...
    if options == "Login":
        ...
        if 'authenticated' in st.session_state and st.session_state['authenticated']:
            ...
            amount = 0  # Hardcoded as amount not being used
            ...
            example_amount = 0  # Hardcoded as amount not being used
    ...
    if st.button("Send Feedback"):
        ...
        st.markdown(f'<a class="button" href="{feedback_email_link}" target="_blank">Send Feedback</a>', unsafe_allow_html=True)
